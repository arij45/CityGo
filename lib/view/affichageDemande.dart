                                                                                ...
                                                                                Row(
                                                                                            ...
                                                                                            fontSize:12
                                                                                              ...
                                                                                              Container(
                                                                                                ...
                                                                                                height: MediaQuery.of(context).size.height * 0.02,
                                                                                                child: Text(
                                                                                                  '${demandesController.DemandesTomorrow[i].usedLuggageBigSize}/${demandesController.DemandesTomorrow[i].luggageBigSize}',
                                                                                                  style: TextStyle(
                                                                                                      color: Color(0xFFFFFFFF),
                                                                                                      fontFamily: 'Georgia',
                                                                                                      fontWeight:FontWeight.bold,
                                                                                              ...
                                                                                              Container(
                                                                                                ...
                                                                                                height: MediaQuery.of(context).size.height * 0.02,
                                                                                                child: Text(
                                                                                                  '${demandesController.DemandesTomorrow[i].usedLuggageMediumSize}/${demandesController.DemandesTomorrow[i].luggageMediumSize}',
                                                                                                  style: TextStyle(
                                                                                                      color: Color(0xFFFFFFFF),
                                                                                                      fontFamily: 'Georgia',
                                                                                                      fontWeight:FontWeight.bold,
                                                                        ...
                                                                        Row(
                                                                          children:[
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              height: MediaQuery.of(context).size.height * 0.02,
                                                                              child: Text(
                                                                                '${demandesController.DemandesToday[i].usedCollie}/${demandesController.DemandesToday[i].collie}',
                                                                                style: TextStyle(
                                                                                    color: Color(0xFFFFFFFF),
                                                                                    fontFamily: 'Georgia',
                                                                                    fontWeight:FontWeight.bold,
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              height: MediaQuery.of(context).size.height * 0.02,
                                                                              child: Text(
                                                                                '${demandesController.DemandesToday[i].usedLuggageBigSize}/${demandesController.DemandesToday[i].luggageBigSize}',
                                                                                style: TextStyle(
                                                                                    color: Color(0xFFFFFFFF),
                                                                                    fontFamily: 'Georgia',
                                                                                    fontWeight:FontWeight.bold,
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              height: MediaQuery.of(context).size.height * 0.02,
                                                                              child: Text(
                                                                                '${demandesController.DemandesToday[i].usedLuggageMediumSize}/${demandesController.DemandesToday[i].luggageMediumSize}',
                                                                                style: TextStyle(
                                                                                    color: Color(0xFFFFFFFF),
                                                                                    fontFamily: 'Georgia',
                                                                                    fontWeight:FontWeight.bold,
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    ...
                                                    key: Key('destinationText_${demandesController.DemandesToday[i].Destination}'), // Add this line
                                                    style: TextStyle(
                                                      fontSize: 15,
                                                      fontFamily: 'Georgia',
                                                      fontWeight: FontWeight.bold,
